...
function menuBar(){
    ...
    <div class="menubar_logo">
        <img class="bar-img1" src="../assets/header/namelogo.svg" alt="">
        <img class="close-img" src="../assets/header/close.png" alt="" onclick="document.querySelector('#sidenav').innerHTML=''">
    </div>
    <div class="menu">
        <div class="main_nav">
